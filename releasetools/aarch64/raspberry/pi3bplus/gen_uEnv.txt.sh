...
list="0x42000000 kernel.bin
0x43000000 ds.elf
0x43800000 rs.elf
0x44000000 pm.elf
0x44800000 sched.elf
0x45000000 vfs.elf
0x45800000 memory.elf
0x46000000 tty.elf
0x46800000 mib.elf
0x47000000 vm.elf
0x47800000 pfs.elf
...
echo "bootcmd=run $BOOT"
echo "bootargs=console=$CONSOLE rootdevname=c0d0p1 verbose=$VERBOSE hz=$HZ"
echo
echo 'bootminix=setenv bootargs \$bootargs board_name=\$board_name ; echo \$bootargs; go  0x42000000 \\\"$bootargs\\\"'
echo
